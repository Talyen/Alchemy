...
- **Wish** — Offers cards from the eligible offer pool, excluding the source card; the chosen card enters the hand when space is available. Choice bonuses and queued offerings follow [Wishes and Mana](./TALENT_RULES.md#wishes-and-mana).
