...
- **Player damage mitigation** — Burn, Poison, and Bleed ticks retain their damage type through flat reductions and Gear resistance. Enemy attack buildup, ordinary enemy Leech (including Flesheater), and Armor decay use damage after all applicable mitigation, before death prevention; fully resisted damage grants none. Later hero healing cannot cancel earned Leech. Ravenous still limits Leech to actual Health lost.
...
- **Shield Slam** — removes 2 enemy Armor on Physical attacks while the player has Block. Rupture requires positive Physical damage to detonate Bleed; a fully blocked or armored hit does not detonate it.
