...
| Lifecycle                                             | `run-session-lifecycle-port.ts` → `run-lifecycle.ts` / `run-presentation-lifecycle.ts` | Restore, snapshot, teardown, battle sync                                                                                                                                                                                                          |
...
| Lifecycle                    | `run-session-lifecycle-port.ts`                                                | Public seam over `run-lifecycle.ts` / `run-presentation-lifecycle.ts`                                                    |
