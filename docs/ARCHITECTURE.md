...
| Kind                         | Module                                                                         | Role                                                                                                                                                                                                                   |
| ---------------------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Reads (imperative)           | `run-session-read-port.ts`                                                     | Curated data-only surface over `run-reads.ts` (`readActiveRun()`, `readRunProfile()`, `readRunSession()`, `readBattle()`, `readShopFirstPurchaseUsed()`, …)                                                            |
