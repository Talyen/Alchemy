...
| **FadeSlot / screen fade** | Sequential opacity enter/exit (`shared-ui`); route wrapper `page-enter` / `page-exit`. See [WORKFLOWS § Screen fade](./WORKFLOWS.md#screen-fade-motion).                                                                                                            |
