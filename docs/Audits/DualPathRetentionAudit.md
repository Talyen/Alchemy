...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Zero live consumers                                                                                                                                                                                                                                                 | `DeadCodeRatioAudit.md`                                                                                                    |
| Single intentional entry that is noun theater / rename ceremony (no second product path to collapse, or the “owner” is not a public import target)                                                                                                                  | `InelegantSlopAudit.md`                                                                                                    |
| Wrong owner **and** leftover twin                                                                                                                                                                                                                                   | `StateGravityOwnershipAudit.md` (move, then delete the old path)                                                           |
| Wrong owner without a twin                                                                                                                                                                                                                                          | `StateGravityOwnershipAudit.md`                                                                                            |
| Duplicate product screens / shells                                                                                                                                                                                                                                  | `DuplicateFeatureSurfaceAudit.md`                                                                                          |
| Twin kept reachable only by test scaffolding asserting one rule                                                                                                                                                                                                     | `UnitTestAudit.md` / `E2ETestQualityAudit.md` (this audit still owns product-reachable twins; retarget tests after delete) |
| Live mass / mixed jobs on a single path                                                                                                                                                                                                                             | `AuthoredMassHotspotAudit.md`                                                                                              |
| Async races / effect lifetime when isolation is the issue                                                                                                                                                                                                           | `AsyncRaceAudit.md`                                                                                                        |
| Intentional seams (battle RNG injection, persistence write coalescing, options/prefs vs versioned player save, authored game-data vs generated assets/metadata, web vs Electron entrypoints, `run-session-facade` as the feature access path to `run-domain-store`) | Leave alone                                                                                                                |
...
- Do not demote or delete barrel / knip-allowlisted exports that are intentional cross-folder contracts without the same consumer inventory `DeadCodeRatioAudit.md` requires.
...
`DeadCodeRatioAudit.md` owns symbols with **zero** live consumers. This audit owns reachable twins or reachable no-op shims.
