...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Active run / screen / bootstrap | `shared/stores/`, `src/app/use-alchemy-bootstrap.ts`, `shell/use-alchemy-run-controller`                                                                            | `npm test -- tests/app/use-alchemy-bootstrap.test.ts tests/features/alchemy/shared/stores/ tests/features/alchemy/shell/ tests/types/run-architecture-contracts.test.ts` then `npm run lint:boundaries` and `npm run test:e2e:prepush`                                                                                                                                                                                                                                                                 |
