...
Enforced by `eslint.config.js`, `lefthook`, and gate scripts. Stop early if you see one.
...
- Confirm destructive or hard-to-reverse actions before the **first** attempt.
