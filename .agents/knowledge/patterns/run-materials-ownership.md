...
Owner: [WORKFLOWS.md](../../../Docs/RUN_WORKFLOWS.md#grant-materials-during-a-run) owns the call pattern; [Armory write paths](../../../Docs/ARMORY.md#write-paths) distinguishes in-run salvage from meta grants.
