...
2. Draft the smallest honest TypeScript contract before concrete React/handler code. Keep invalid states out of the model. Comments follow [AGENTS.md § Change guards](../../../AGENTS.md#change-guards): non-obvious invariants only, never import/consumer graphs.
