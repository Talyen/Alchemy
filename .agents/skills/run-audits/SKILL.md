...
3. Inspect the worktree and preserve unrelated changes. Check [decisions.md](../../../docs/Audits/decisions.md) before confirming candidates.

Do not run an uncited sibling audit, broaden into standing cleanup, or manufacture findings — zero confirmed findings is success.
