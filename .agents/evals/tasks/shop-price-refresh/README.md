...
Setup: Use an isolated eval worktree and adjust shop pricing/refresh logic via `shop-transactions.ts` draft recipe.
...
Run: `npm run verify -- src/features/alchemy/run-loop/shop/trinket-shop-commands.ts`
