...
describe("CyclingShineBorder", () => {
  it("drives the shine from an interpolatable color variable", () => {
    ...
    expect(shine.querySelector<HTMLElement>(".shine-border-paint")!.style.backgroundImage).toBe(
      "radial-gradient(var(--cycle-shine), var(--cycle-shine))",
    );
    expect(shine.querySelector<HTMLElement>(".shine-border-paint")!.style.backgroundColor).toBe("var(--cycle-shine)");
