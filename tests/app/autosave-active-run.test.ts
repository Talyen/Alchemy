...
describe("buildAlchemySaveDataFromStores permanent progress", () => {
  it("reads materialInventory and talentXP from the run-domain profile when args are omitted", () => {
    setRunProgress({
      materialInventory: { wood: 12, iron: 3, herbs: 1, food: 0, crystal: 2, stone: 0, hide: 0 },
      talentXP: { burn: 40 },
    ...
    expect(save.materialInventory).toEqual({ wood: 12, iron: 3, herbs: 1, food: 0, crystal: 2, stone: 0, hide: 0 });
