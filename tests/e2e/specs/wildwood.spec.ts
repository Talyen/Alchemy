...
test.describe("Wildwood Draft", () => {
  test("drafts six cards and starts a modified boss battle", slow, async ({ page, fastBattle }) => {
    void fastBattle;
  ...
  test("wildwood victory skips recovery and keeps current health", critical, async ({ page, fastBattle }) => {
  ...
  test("skips reward after wildwood victory and starts next boss", slow, async ({ page, fastBattle }) => {
...
test.describe("Wildwood Traits", slow, () => {
  ...
  test("reloading mid-draft preserves combat trait assignment", async ({ page, fastBattle }) => {
    void fastBattle;
