...
import {
  ...
  DESTINATION_CHOICES, DESTINATIONS_PER_ACT, ACTS_PER_RUN,
  BOSS_STAT_MULTIPLIER, ACT_SCALING_INCREMENT, BOSS_TRINKET_REWARD_CHOICES,
  MASTER_GAIN, DEFAULT_MUSIC_VOLUME, MUSIC_BASE_PATH,
  SHIMMER_DURATION_MS, SHIMMER_COOLDOWN_MS, SHIMMER_INTRO_DELAY_MS,
  COMBAT_TEXT_LIFETIME_MS, COMBAT_TEXT_LANE_DELAY_MS, GHOST_EXTRA_BUFFER_MS,
  DRAG_START_THRESHOLD_PX, DRAG_ROTATION_CLAMP, DRAG_ROTATION_DIVISOR,
  GHOST_TRAVEL_SCALE, BATTLEFIELD_HIT_FRACTION, PLAYER_PANEL_OFFSET_FRACTION,
