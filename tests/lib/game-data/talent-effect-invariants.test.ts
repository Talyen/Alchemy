...
const LEGACY_SNAPSHOT_FIELDS: ReadonlyArray<keyof TalentEffectManifest> = [
  ...
  "freezePreventsEnemyDodge",
  "shopFreeRefresh",
  "startGold",
  "armorOnPotionCard",
  "blockPerGold",
  "leechBlockBelowHalfPercent",
  "leechPoisonDamageChance",
  "leechBleedDamageChance",
  "blockOnHolyCard",
  "nextAttackPhysicalOnLeechToFull",
