...
function buildGearArtContent(manifest) {
  ...
  // gear-art.generated.ts maps definition IDs through the same namespace.
...
async function syncBarrels(configs, { check = false, verify = [] } = {}) {
  ...
  // Verify-only configs are compared before anything is written: gear-art.generated.ts
...
export async function syncAssets(options) {
  ...
  // `npm run sync:art`, since gear-art.generated.ts imports assets.generated.ts and a
