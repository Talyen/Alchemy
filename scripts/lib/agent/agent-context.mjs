...
export const CONTEXT_TASKS = {
  ...
  tooltip: {
    ...
    entrypoints: ["src/lib/keyword-text.ts", "src/features/alchemy/shared/ui/cards/card-description-ui.tsx"],
  },
  gear: {
  ...
  tooling: {
    ...
    entrypoints: ["scripts/lib/verification/change-routes.mjs", "scripts/README.md"],
  },
  verification: {
    matches:
