    ...
    <div className="flex h-screen w-screen items-center justify-center overflow-hidden bg-background p-4">
      <div className="relative" style={frameStyle}>
        <div className="absolute left-0 top-0 overflow-hidden bg-background" style={stageStyle}>
          ...
          {run.screen === "destination" ? <DestinationScreen destinationOptions={run.destinationOptions} hoveredDestination={run.hoveredDestination} onHoverChange={run.setHoveredDestination} onChoose={run.handleDestinationChoice} destinationGuidePath={run.destinationGuidePath} destinationMapRef={run.destinationMapRef} destinationHeaderRef={run.destinationHeaderRef} destinationButtonRefs={run.destinationButtonRefs} /> : null}
