...
export const enemyLootTables: Record<string, EnemyLootTable> = {
  ...
  "forge-golem": {
    ...
    bonuses: [lootEntry("iron", 0, 2, 0.6), lootEntry("gems", 0, 1, 0.4), lootEntry("stone", 0, 1, 0.5)],
  },
  frostwarden: {
  ...
  "winter-wolf": {
    guaranteed: materialCost({ food: 1, gems: 1 }),
    bonuses: [lootEntry("gems", 0, 1, 0.4), lootEntry("hide", 0, 1, 0.4)],
  },
  "ice-wraith": {
...
type EndOfRunHomesteadEffects = Pick<
  ...
  "endRunFoodPerRoom" | "endRunHerbsPerRoom" | "endRunHidePerRoom" | "endRunGemsPerRoom" | "herbFindBonus"
>;
