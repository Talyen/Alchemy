...
export const BATTLE_END_TRANSITION_DELAY = 1300;
...
export const SHAKE_DURATION = HIT_SHAKE_DELAY_MS + 340;
...
export const COMPANION_ATTACK_DELAY = 500;
export const NAVIGATION_DELAY_MS = 100;
export const CAMPFIRE_ANIMATION_MS = 1200;
export const CAMPFIRE_CONTINUE_DELAY = 800;
