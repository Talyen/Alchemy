...
export const COMBAT_TEXT_MERGE_WINDOW_MS = 250;
export const COMBAT_TEXT_LIFETIME_MS = 1100;
export const COMBAT_TEXT_MIN_LIFETIME_MS = 400;
export const COMBAT_TEXT_MAX_BURSTS_PER_RAIL = 3;
