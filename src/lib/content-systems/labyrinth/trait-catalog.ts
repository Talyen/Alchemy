...
export const LABYRINTH_TRAITS = {
  ...
  "herbal-hearth": room("rest", "Herbal Hearth", "Rest restores Health, grants a random Potion", "health"),
  ...
  apprentice: room("equipment-shop", "Apprentice", "Basic Gear costs half as much Gold", "gold"),
  ...
  "echoing-altar": room("corruption", "Echoing Altar", "Added effects match your card's traits", "consume"),
