...
const KNIGHT_IDLE_FRAMES = Array.from({ length: 4 }, (_, i) => `assets/characters/knight-idle-f${i}.png`)
const ROGUE_IDLE_FRAMES = Array.from({ length: 4 }, (_, i) => `assets/characters/rogue-idle-f${i}.png`)
const WIZARD_IDLE_FRAMES = Array.from({ length: 4 }, (_, i) => `assets/characters/wizard-idle-f${i}.png`)
