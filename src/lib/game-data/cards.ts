...
export const cardLibrary: BattleCard[] = [
  { id: "slash", title: "Slash", descriptionLines: ["Deal 5 Physical damage"], art: slash, cost: 1, template: "mechanical", effects: [{ kind: "damage", damageType: "physical", amount: 5 }] },
  { id: "stab", title: "Stab", descriptionLines: ["Deal 4 Physical damage"], art: stab, cost: 1, template: "mechanical", effects: [{ kind: "damage", damageType: "physical", amount: 4 }] },
  { id: "bash", title: "Bash", descriptionLines: ["Deal 4 Stun damage"], art: bash, cost: 1, template: "mechanical", effects: [{ kind: "damage", damageType: "stun", amount: 4 }] },
  ...
  { id: "meteor", title: "Meteor", descriptionLines: ["Deal 10 Burn damage", "Lose 1 Mana Crystal", "Consume"], art: meteor, cost: 1, template: "arcane", consume: true, effects: [{ kind: "damage", damageType: "burn", amount: 10 }, { kind: "lose-max-mana", amount: 1 }] },
  { id: "steal", title: "Steal", descriptionLines: ["Steal 4 Gold"], art: steal, cost: 1, template: "arcane", effects: [{ kind: "gain-gold", amount: 4 }] },
  { id: "blessed-aegis", title: "Blessed Aegis", descriptionLines: ["Deal Holy damage equal to your Block"], art: blessedAegis, cost: 1, template: "holy", effects: [{ kind: "damage", damageType: "holy", amount: 0, fromBlock: true }] },
  { id: "wish", title: "Wish", descriptionLines: ["Wish 1"], art: wish, cost: 1, template: "arcane", effects: [{ kind: "wish", amount: 1 }] },
  { id: "cleanse", title: "Cleanse", descriptionLines: ["Remove a harmful status effect"], art: cleanse, cost: 1, template: "holy", effects: [{ kind: "remove-harmful-status", amount: 1 }] },
  ...
  { id: "poison-dagger", title: "Poison Dagger", descriptionLines: ["Deal 2 Poison damage"], art: poisonDagger, cost: 1, template: "alchemy", effects: [{ kind: "damage", damageType: "poison", amount: 2 }] },
  { id: "fireball", title: "Fireball", descriptionLines: ["Deal 3 Burn damage"], art: fireball, cost: 1, template: "arcane", effects: [{ kind: "damage", damageType: "burn", amount: 3 }] },
  { id: "fangs", title: "Fangs", descriptionLines: ["Deal 2 Bleed damage", "Leech"], art: fangs, cost: 1, template: "alchemy", effects: [{ kind: "damage", damageType: "bleed", amount: 2, lifesteal: true }] },
  { id: "frostbolt", title: "Frostbolt", descriptionLines: ["Deal 3 Freeze damage"], art: frostbolt, cost: 1, template: "arcane", effects: [{ kind: "damage", damageType: "freeze", amount: 3 }] },
  ...
  { id: "mana-berries", title: "Mana Berries", descriptionLines: ["Restore 2 Mana", "Consume"], art: manaBerries, cost: 1, template: "nature", consume: true, effects: [{ kind: "restore-mana", amount: 2 }] },
  ...
  { id: "panacea-potion", title: "Panacea Potion", descriptionLines: ["Remove 1 harmful status effect", "Consume"], art: panaceaPotion, cost: 1, template: "alchemy", consume: true, effects: [{ kind: "remove-harmful-status", amount: 1 }] },
