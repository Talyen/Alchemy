...
export const cardLibrary: BattleCard[] = [
  ...
  { id: "cleanse", title: "Cleanse", descriptionLines: ["Remove an Ailment"], art: cleanse, cost: 1, template: "holy", effects: [{ kind: "remove-ailment", amount: 1 }] },
  ...
  { id: "panacea-potion", title: "Panacea Potion", descriptionLines: ["Remove 1 Ailment", "Consume"], art: panaceaPotion, cost: 1, template: "alchemy", consume: true, effects: [{ kind: "remove-ailment", amount: 1 }] },
