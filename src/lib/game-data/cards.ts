...
export const cardLibrary: BattleCard[] = [
  ...
  },
  {
    id: "stab",
    title: "Stab",
    descriptionLines: ["Deal 3 Bleed damage"],
    art: stab,
    cost: 1,
  ...
  },
  {
    id: "meteor",
    title: "Meteor",
    descriptionLines: ["Deal 10 Burn damage", "Lose 1 Mana Crystal", "Consume"],
    art: meteor,
    cost: 1,
    consume: true,
    effects: [
  ...
  },
  {
    id: "heal",
    title: "Heal",
    descriptionLines: ["Restore 5 Health"],
    art: heal,
    cost: 1,
    effects: [{ kind: "heal", amount: 5 }],
  },
  ...
  },
  {
    id: "fangs",
    title: "Fangs",
    descriptionLines: ["Deal 2 Bleed damage", "Leech"],
    art: fangs,
    cost: 1,
    effects: [{ kind: "damage", damageType: "bleed", amount: 2, lifesteal: true }],
  },
  {
    id: "frostbolt",
    title: "Frostbolt",
  ...
  },
  {
    id: "mixed-potion",
    title: "Mixed Potion",
    descriptionLines: ["Mixed at an Alchemist's Shop"],
    art: mixedPotion,
    cost: 1,
    consume: true,
    effects: [],
