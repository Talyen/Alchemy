...
export const talentPool: TalentDefinition[] = [
  ...
  },
  {
    ...
    description: "After you play a Holy card, your next Wish offers 1 additional card choice",
    icon: "Sparkles",
    effects: [setEffect("wishExtraChoiceAfterHolyCard", true)],
  },
  ...
  },
  {
    ...
    keywordId: "leech",
    name: "Cull the Weak",
    description: "Leech cards deal 25% more damage against enemies below 50% Health",
    icon: "Skull",
    effects: [setEffect("leechCardDamageVsLowHealthPercent", 25)],
  },
  {
