...
export const talentPool: TalentDefinition[] = [
  ...
  },
  {
    ...
    keywordId: "dodge",
    name: "Unburdened",
    description: "+5% Dodge while you have no Block",
    icon: "ShieldOff",
    effects: [addEffect("dodgeChanceWithoutBlock", 5)],
  },
  {
  ...
  },
  {
    ...
    keywordId: "archery",
    name: "Longshot",
    description: "Archery cards deal double damage against full health enemies",
    icon: "ArrowRight",
  ...
  },
  {
    ...
    keywordId: "bleed",
    name: "Mortal Wound",
    description: "Bleed halves the Health enemies restore",
    icon: "Bone",
  ...
  },
  {
    ...
    keywordId: "poison",
    name: "Necrosis",
    description: "Poison halves the Health enemies restore",
    icon: "Skull",
