...
export const talentPool: TalentDefinition[] = [
  ...
  talent(
    ...
    "companion",
    "Watchdog",
    "When your Companion deals damage, gain 1 Block",
    "ShieldAlert",
  ...
  talent(
    ...
    "gold",
    "Coinmail",
    "Gold gained during combat also grants a quarter as much Block",
    "Trophy",
  ...
  talent(
    ...
    "health",
    "Overflow",
    "When you restore Health beyond your maximum, gain a quarter of the excess as Block",
    "Container",
  ...
  talent(
    ...
    "holy",
    "Radiant Guard",
    "Holy damage grants Block for 10% of the amount dealt",
    "ShieldPlus",
    setEffect("holyBlockPercentFromDamage", 10),
  ),
  talent(
    "holy-lifesteal",
    "holy",
  ...
  talent(
    ...
    "mana",
    "Arcane Mending",
    "Restore 1 Health when you gain Mana",
    "Wand",
    setEffect("healOnManaGain", 1),
  ),
  talent(
    "nature-overgrowth",
    "nature",
