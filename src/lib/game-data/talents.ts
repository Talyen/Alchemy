...
export const talentPool: TalentDefinition[] = [
  ...
  { id: "holy-dmg-1", keywordId: "holy", name: "Placeholder 1", description: TALENTS_CONFIG.PLACEHOLDER_DESCRIPTION },
