...
const affixRows = [
  ...
  uniqueAffix(
    ...
    "offensive",
    "gold",
    "Gold gained in combat grants equal Forge. Forge also strengthens Holy damage.",
  ...
  uniqueAffix(
    ...
    "defensive",
    "dodge",
    "When you Dodge an attack, draw and play a random card",
    "dodgeDrawAndPlay",
    "physical",
  ),
  {
  ...
  uniqueAffix(
    ...
    "offensive",
    "freeze",
    "Freeze damage grants Block and Freezing an enemy restores Mana equal to half your Block",
  ...
  uniqueAffix(
    ...
    "offensive",
    "holy",
    "Holy damage causes Stun build-up and you gain {value} Gold when you Stun an enemy",
    "holyStunBuildupGold",
    "stun",
  ),
