...
export const gearAffixCatalog: Record<GearAffixId, GearAffixDefinition> = {
  ...
  "burn-on-wish": affix(
    ...
    "offensive",
    "burn",
    "Deal {value} Burn damage on Wish",
    "burnOnWish",
    { min: 1, max: 2 },
    { min: 3, max: 4 },
    "wish",
  ...
  "nature-leech": affix(
    ...
    "offensive",
    "leech",
    "Nature damage has a {value}% chance to Leech",
    "natureLeechChance",
    { min: 7, max: 8 },
    { min: 9, max: 10 },
    "nature",
  ...
  "resist-physical": affix(
    ...
    "defensive",
    "physical",
    "Reduce Physical damage taken by {value}%",
    "resistPhysical",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "resist-stun": affix(
    ...
    "defensive",
    "stun",
    "Reduce Stun damage taken by {value}%",
    "resistStun",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "resist-holy": affix(
    ...
    "defensive",
    "holy",
    "Reduce Holy damage taken by {value}%",
    "resistHoly",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "resist-burn": affix(
    ...
    "defensive",
    "burn",
    "Reduce Burn damage taken by {value}%",
    "resistBurn",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "resist-poison": affix(
    ...
    "defensive",
    "poison",
    "Reduce Poison damage taken by {value}%",
    "resistPoison",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "resist-bleed": affix(
    ...
    "defensive",
    "bleed",
    "Reduce Bleed damage taken by {value}%",
    "resistBleed",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "resist-freeze": affix(
    ...
    "defensive",
    "freeze",
    "Reduce Freeze damage taken by {value}%",
    "resistFreeze",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "resist-nature": affix(
    ...
    "defensive",
    "nature",
    "Reduce Nature damage taken by {value}%",
    "resistNature",
    { min: 10, max: 15 },
    { min: 15, max: 20 },
  ),
  "health-per-turn": affix(
    ...
    "defensive",
    "health",
    "Restore {value} Health each turn",
    "healthPerTurn",
    { min: 1, max: 2 },
    { min: 3, max: 4 },
  ),
