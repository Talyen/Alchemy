...
export const cardSounds: Record<string, string[]> = {
  ...
  "skeleton-companion": ["swish-hit.ogg"],
  "pixie-companion": ["buff-pickup-1.ogg"],
  "mana-moth-companion": ["energy-noise.ogg"],
  "will-o-wisp-companion": ["music-box-mystery.ogg"],
  "golden-retriever-companion": ["coins-gather-quick.ogg"],
  "shield-scarab-companion": ["sword-blocked-1.ogg"],
  "library-owl-companion": ["page-turn.ogg"],
  "fox-companion": ["swipe.ogg"],
