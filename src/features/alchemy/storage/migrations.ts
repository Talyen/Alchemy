...
export function normalizeSaveData(parsed: Partial<SaveData> | RawSaveData): SaveData {
  ...
  return {
    ...
    gameBuildVersion: typeof migrated.gameBuildVersion === "string" ? migrated.gameBuildVersion : CURRENT_GAME_BUILD_VERSION,
...
function normalizeResolution(value: unknown): SaveData["selectedResolution"] {
  return resolutionOptions.some((option) => option.value === value) ? value as SaveData["selectedResolution"] : defaultSaveData.selectedResolution;
}
