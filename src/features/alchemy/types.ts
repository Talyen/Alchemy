...
export type Screen = "menu" | "game-mode-select" | "character-select" | "difficulty-select" | "battle" | "rewards" | "destination" | "options" | "collection" | "talents" | "homestead" | "game-over" | "campfire" | "shop" | "alchemist" | "mystery" | "corruption" | "act-complete" | "run-victory" | "labyrinth-map" | "wildwood-select" | "wildwood-battle";
