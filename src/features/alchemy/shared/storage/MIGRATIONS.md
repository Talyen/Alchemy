...
Dev builds also accept `?wipeLocalSave=1` (exact value) to clear local candidates before bootstrap via the `localWipe` path. Device display preferences survive either deletion path.
